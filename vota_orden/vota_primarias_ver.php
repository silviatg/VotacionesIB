...
?>
<form id="form1" name="form1" method="post"  class="well" action="resultados_primarias_ver.php?idvot=<?php echo "$idvot";?>">
Puede verificar su voto, para ello es necesario que ponga la clave que uso al votar <br />
   ...
   <br /> <input type="submit"  class="btn btn-lg btn-primary pull-right"  name="Verificar" id="Verificar" value="Enviar" />
 <p>&nbsp;</p>
 </form>
<?php }?>
        <!---->
