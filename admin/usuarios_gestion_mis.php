      ...
      <?php  include("../votacion/caja_mensajes_1.php"); ?>
       ...
       <div class="row">
        ...
        <div class="col-md-10">
                   ...
                   <!--Comiezo-->
          <h1>BUSCAR  EN EL CENSO DE USUARIOS PARA VER QUE VOTACIONES TIENEN </h1>
            <p>&nbsp;</p>
			<!---->
     
      <form id="form1" name="form1" method="post" action="usuarios_busq_mis.php" class="well form-horizontal">
        ...
        <div class="form-group">       
          <label for="nombre_usuario" class="col-sm-3 control-label"> Correo electronico</label>
            ...
            <div class="form-group">       
          <label for="nombre_usuario" class="col-sm-3 control-label"> NIF</label>
        ...
        <div class="form-group">       
          <label for="nombre_usuario" class="col-sm-3 control-label"> Provincia</label>
...
<div class="form-group">       
          <label for="nombre_usuario" class="col-sm-3 control-label"> Nivel administrativo</label>
