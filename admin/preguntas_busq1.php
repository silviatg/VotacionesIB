...
$sql = "SELECT id,pregunta ,respuestas FROM $tbn13 WHERE id_votacion = '$idvot' ";
...
do {
 ...
 ?>
		  <tr>
               ...
               <td><a href="preguntas.php?id=<?php echo  "$row[0]" ?>&idvot=<?php echo  "$idvot" ?>&acc=modifika " class="btn btn-primary btn-xs">modificar</a></td>              
              <td>
          <a href="preguntas_borra.php?id=<?php echo  "$row[0]" ?>&idvot=<?php echo  "$idvot" ?>" onClick="return borrarevento()" class="btn btn-danger btn-xs">Borrar </a>
