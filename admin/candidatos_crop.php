    ...
    ================================================== -->
      <?php  include("../votacion/caja_mensajes_1.php"); ?>
       ...
       <div class="row">
        ...
        <a href="candidatos_actualizar.php?id=<?php echo "$idcat"; ?>&idvot=<?php echo $_GET['idvot']; ?>" class="btn btn-primary pull-right">Modificar esta opcion o candidato</a>
...
<h3>MODIFICAR IMAGEN DE LA OPCION O CANDIDATO</h3>
            ...
            <div class="bbody">
              ...
              <form id="upload_form" enctype="multipart/form-data" method="post" action="candidatos_actualizar.php?id=<?php echo "$idcat"; ?>&idvot=<?php echo $_GET['idvot']; ?>" onsubmit="return checkForm()" class="well">
                    ...
                    <div class="step2">
                      <p>&nbsp;</p>
                      <h3>PASO 2: Seleccione la zona de la imagen que desea recortar para usar como imagen del candidato u opcion</h3>
                        <img id="preview" />
                        ...
                        <input name="modifika_imagen" type="submit" class="btn btn-primary pull-right" id="modifika_imagen" value="Modifica la imagen"/>
                    </div>
                </form>
            </div>
        </div>
