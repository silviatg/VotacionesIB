      ...
      <?php  include("../votacion/caja_mensajes_1.php"); ?>
       ...
       <div class="row">
        ...
        <div class="col-md-10">
                   ...
                   <!--Comiezo-->
<h2>Buscar VOTACIONES para ver censos votaciones</h2>

     <?php if ($_SESSION['nivel_usu']==2){?>
      
   <div  class="well">     
       
 <h4> <a href="votantes_list_votaciones.php">Todas las Votaciones Estatales</a></h4>
    
    </div>
    
   
    
    <form id="formulario1" name="formulario1" method="post" action="votantes_list_votaciones.php"  class="well">   
 ...
 if ($_SESSION['nivel_usu']==2){
  $options2 = "select DISTINCT id, provincia from $tbn8 where especial=0 order by ID";
	...
	//$lista1 .="    <label><input type=\"checkbox\" name=\"tipo_$id_pro\" value=\"$id_pro\" id=\"tipo_$id_pro\" $chequed /> $name1</label> <br/>";
        ...
        <form id="form1" name="form1" method="post" action="votantes_list_votaciones.php"  class="well">
