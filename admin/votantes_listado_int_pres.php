...
$sql = "SELECT a.ID, 	a.nombre_usuario , a.correo_usuario, b.fecha, b.forma_votacion,a.tipo_votante FROM $tbn9 a,  $tbn2 b where (a.id=b.id_votante) and a.id_provincia = '$id_provincia' and a.tipo_votante <='$tipo_votante' and b.id_votacion=$idvot and b.forma_votacion='$tipo_voto' ";
if ($row_vot[5]==1){
	$id_provincia=$_GET['id_nprov'];
$sql = "SELECT a.ID, 	a.nombre_usuario , a.correo_usuario, b.fecha, b.forma_votacion,a.tipo_votante  FROM $tbn9 a,  $tbn2 b where (a.id=b.id_votante) and a.id_provincia = '$id_provincia' and a.tipo_votante <='$tipo_votante' and b.id_votacion=$idvot and b.forma_votacion='$tipo_voto' ";
...
$sql = "SELECT a.ID, 	a.nombre_usuario , a.correo_usuario, b.fecha, b.forma_votacion,a.tipo_votante  FROM $tbn9 a,  $tbn2 b where (a.id=b.id_votante) and a.id_ccaa = '$id_ccaa' and a.tipo_votante <='$tipo_votante' and b.id_votacion=$idvot  and b.forma_votacion='$tipo_voto' ";
...
$sql = "SELECT a.ID, 	a.nombre_usuario , a.correo_usuario, b.fecha, b.forma_votacion,a.tipo_votante  FROM $tbn9 a,  $tbn2 b where (a.id=b.id_votante) and a.id_municipio = '$id_municipio' and a.tipo_votante <='$tipo_votante' and b.id_votacion=$idvot  and b.forma_votacion='$tipo_voto' ";
...
$sql = "SELECT a.ID, a.nombre_usuario , a.correo_usuario 
 ...
 WHERE  EXISTS (
	 SELECT  * 
	 FROM $tbn2 b
	 WHERE a.id=b.id_votante  and b.id_votacion=$idvot  and b.forma_votacion='$tipo_voto'
...
<h1>Votacion de <?php echo "$row_vot[2]" ?></h1>
          ...
          <h3>Listado del censo que han votado PRESENCIALMENTE  
            <?php if ($row_vot[5]==1 and $_GET['id_nprov']!=""){	?>
