 ...
 <div class="container">
    ...
    ================================================== -->
	  ...
	  $url_usurio_vot="&id_usurio_vot=$id_usurio_vot";
		 ...
		 $sql = "SELECT  ID , nombre_votacion,tipo, tipo_votante, activa, activos_resultados,seguridad,interventor  FROM $tbn1 where anadido='$id_usurio_vot'   ORDER BY 'ID' ";
...
<table width="100%" border="0">
  ...
  <?php  if($row[6]==3 or $row[6]==4 or $row[7]=="si"){
	...
	?>
            ...
            echo "<div class=\"alert alert-success\">¡No se ha encontrado ningún grupo de trabajo! </div>";
            }
