...
echo "Borrados correctamente $datos usuarios";
}	 
...
$sql = "SELECT ID, 	nombre_usuario , correo_usuario,tipo_votante FROM $tbn9  WHERE id_provincia='$id_provincia' and  tipo_votante <='$tipo_votante' ";	
}
else if ($row_vot[5]==2){
$sql = "SELECT ID, 	nombre_usuario , correo_usuario,tipo_votante FROM $tbn9  WHERE id_ccaa='$id_ccaa' and tipo_votante <='$tipo_votante' ";	
...
$sql = "SELECT ID, 	nombre_usuario , correo_usuario,tipo_votante FROM $tbn9  WHERE id_municipio='$id_municipio' and tipo_votante <='$tipo_votante' ";	
}
else {
	////////////comprobar si funciona bien
	$sql = "SELECT a.ID, a.nombre_usuario , a.correo_usuario,a.tipo_votante FROM $tbn9 a,$tbn6 b  WHERE (a.ID= b.id_usuario) and id_grupo_trabajo='$id_grupo_trabajo' and a.tipo_votante <='$tipo_votante' ";	
...
echo " <div class=\"alert alert-succes\">¡No se ha encontrado votantes para esta encuesta!</div ";
}
